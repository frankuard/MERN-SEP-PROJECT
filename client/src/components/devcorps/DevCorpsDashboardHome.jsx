import DevCorpsGreetingHeader from './DevCorpsGreetingHeader';
...
// Same layout as the Student/Teacher dashboard homes — only CanteenSpecial
// and any attendance/class cards are intentionally omitted. The hero swaps
// the attendance card for the DevCorps Next Upcoming Event card.
const DevCorpsDashboardHome = ({ t, greeting, memberName, onNavigateTab }) => {
  return (
    <div className="dashboard-playful relative space-y-8 pb-4">
      {/* Background decorative dots — identical to student/teacher */}
...
export default DevCorpsDashboardHome;